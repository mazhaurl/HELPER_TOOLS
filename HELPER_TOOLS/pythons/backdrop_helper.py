...
class md_backdrop(QWidget, Ui_Form):
 ...
 #Custom  
    def copy_from_user(self):
       ...
       bd_node['label'].setValue(f"<center>{self.lineEdit.text().upper()}</center>")
 ...
 #Custom  
    def Cleanup(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>CLEANUP</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
 ...
 #Custom  
    def roto(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>ROTO</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
 ...
 #Custom  
    def projection(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>PROJECTION</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
 ...
 #ForPlate   
    def Plate(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>PLATE</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For Key
    def Keying(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>KEY</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For Denoise
    def Denoise(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>DENOISE</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For Despill
    ...
    def Desipill(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>DESPILL</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For CC
    ...
    def CC(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>COLOR CORRECTION</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For Transform
    ...
    def Transfrom(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>TRANSFROM</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For 3d
    ...
    def ThreeD(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>3D</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For DMP
    ...
    def DMP(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>DMP</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For Precomp
    ...
    def Precomp(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>PRECOMP</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For Grain
    ...
    def Grain(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>GRAIN</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For Render
    ...
    def Render(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>RENDER</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For LensFX
    ...
    def LensFX(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>LENS EFFECT</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
...
#For Alpha
    ...
    def Alpha(self):
       ...
       bd_node = autoBackdropmd()
       bd_node['label'].setValue('<center>ALPHA</center>')
       bd_node['note_font'].setValue('bold')
       bd_node['note_font_size'].setValue(50)
